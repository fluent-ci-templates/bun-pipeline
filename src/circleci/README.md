...
[![](https://img.shields.io/codecov/c/gh/fluent-ci-templates/bun-pipeline)](https://codecov.io/gh/fluent-ci-templates/bun-pipeline)


The following command will generate a `.circleci/config.yml` file in your project:

```bash
fluentci cci init -t bun_pipeline
```
